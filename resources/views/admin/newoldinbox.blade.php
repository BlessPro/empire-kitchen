                        ...
                        <div class="flex flex-1 overflow-hidden">
                            ...
                            <aside class="w-1/3 p-4 overflow-y-auto bg-white border-r">
                                ...
                                @foreach ($users as $user)
                                    <a href="{{ route('inbox', $user->id) }}"
                                        ...
                                        <ul>
                                            <li
                                                class="flex items-center px-4 py-3 space-x-3 border-b cursor-pointer hover:bg-gray-100">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-400">Can you check the server status?
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                            ...
                            <section class="flex flex-col flex-1 bg-gray-100">
                                ...
                                <div class="flex-1 p-6 space-y-4 overflow-y-auto">
                                    ...
                                    <div class="flex justify-start ">
                                        <img src="admin-profile.jpg"
                                            class="flex items-center justify-center w-[42px] h-[42px] font-bold text-white rounded-full mr-3"
                                            alt="">

                                        <div class="px-4 py-2 text-sm bg-white rounded-[9px] shadow">Yes Sir <span
                                                class="ml-2 text-xs text-gray-400">11:25</span></div>
                                    </div>
                                    @if ($messages)
                                        @foreach ($messages as $message)
                                            <div
                                                class="mb-2 text-sm {{ $message->sender_id == auth()->id() ? 'text-right' : 'text-left' }}">
                                                <div
                            ...
                            {{ $message->sender_id == auth()->id() ? 'bg-blue-500 text-white' : 'bg-gray-300 text-black' }}">
                                    ...
                                    <div class="flex justify-end">
                                        ...
                                        <div class="px-4 py-2 text-sm text-white bg-purple-700 rounded-[9px] shadow">
                                            Thanks! Let me know ASAP... <span
                                                class="ml-2 text-xs text-white">11:25</span></div>
                                    </div>
                                </div>
                    ...
                    fetch(`/inbox/fetch/${receiverId}`)
                        ...
                        .then(data => {
                            ...
                            data.forEach(msg => {
                                ...
                                div.classList.add('mb-2', 'text-sm', msg.sender_id == {{ auth()->id() }} ?
