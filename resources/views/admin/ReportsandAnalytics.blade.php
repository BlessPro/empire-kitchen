                    ...
                    <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2 ">
                           ...
                           <span class="flex flex-col items-center justify-center">
                            ...
                            <ul class="items-center space-y-3">
                              <li class="flex items-center">
                                ...
                                <span class="text-gray-800 font-normal text-[15px]">Completed Projects (5)</span>
                              </li>
                              <li class="flex items-center">
                                <span class="w-10 h-5 rounded-[15px] bg-orange-500  mr-3"></span>
                                <span class="text-gray-800 font-normal text-[15px]">Pending Projects (10)</span>
                              </li>
                              <li class="flex items-center">
                                <span class="w-10 h-5 rounded-[15px] bg-violet-500 mr-3"></span>
                                <span class="text-gray-800 font-normal text-[15px]">Closed Projects (7)</span>
                              </li>
                      ...
                      <div class="bg-white rounded-[20px] pb-2 shadow">
                        ...
                        <div class="flex items-center justify-between pt-4 pb-5 pl-6 pr-6">
                          <p class="text-gray-600 text-[15px] font-Semi-bold">Projects </p>
                                  ...
                                  <tbody>
                                   @foreach($projects as $project)
                                      <tr class="border-t hover:bg-gray-50">
                                          ...
                                          <td class="p-4 text-left"> {{ $project->techSupervisor?->name ?? 'Not Assigned' }}</td>
