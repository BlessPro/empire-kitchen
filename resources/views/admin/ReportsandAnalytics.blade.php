            ...
            <div class="p-6 bg-[#F9F7F7]">
                <div class="mb-[20px]">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <button
                            class="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-purple-800 bg-purple-100 border border-purple-800 rounded-full">
                            Export
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 4v16h16V4H4zm8 8v4m0-4l-2 2m2-2l2 2" />
                            </svg>
                        </button>
                                ...
                                <span class="flex flex-col items-center justify-center">
                                    ...
                                    <ul class="items-center space-y-3">
                                        <li class="flex items-center">
                                            ...
                                            <span class="text-gray-800 font-normal text-[15px]">Pending Projects
                                                {{ $statusCounts['Pending'] }}</span>
                                        </li>
                                        <li class="flex items-center">
                                            <span class="w-10 h-5 rounded-[15px] bg-orange-500  mr-3"></span>
                                            <span class="text-gray-800 font-normal text-[15px]">Ongoing Projects
                                                {{ $statusCounts['Ongoing'] }}</span>
                                        </li>
                                        <li class="flex items-center">
                                            <span class="w-10 h-5 rounded-[15px] bg-violet-500 mr-3"></span>
                                            <span class="text-gray-800 font-normal text-[15px]">Completed Projects
                                ...
                                <span class="flex flex-col items-center justify-center">
                                    ...
                                    <ul class="items-center space-y-3">
                                        <li class="flex items-center">
                                            ...
                                            <i data-feather="trending-up" class="text-green-600 mr-[2px] ml-[10px]"></i>
                                            <h5 class="text-green-600 mr-[2px] ml-[10px]"> 2.6% </h5>

                                        </li>
                                        <li class="flex items-center">
                                            <span class="w-10 h-5 rounded-[15px] bg-violet-500  mr-3"></span>
                                            <span class="text-gray-800 font-normal text-[15px]"> Incoming Payments
                                                ($170,690)</span>
                                        </li>
                                        <li class="flex items-center">
                                            <span class="w-10 h-5 rounded-[15px] bg-[#EAB308] mr-3"></span>
                                            <span class="text-gray-800 font-normal text-[15px]">Outgoing Payments
                                                ($73,807)</span>
                                        </li>
                    ...
                    <div class="bg-white rounded-[20px] pb-2 shadow">
                        ...
                        <div class="flex items-center justify-between pt-4 pb-5 pl-6 pr-6">
                            ...
                            <div class="flex gap-3">
                                <button
                                    class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 border border-gray-300 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M10 6h4M6 10h12M6 14h12M10 18h4" />
                                    </svg>
                                    Filter
                                </button>
                            ...
                            <tbody>
                                @foreach ($projects as $project)
                                    <tr class="border-t hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-1 text-sm  ${item.statusStyle}">
                                            {{ $project->client->firstname . ' ' . $project->client->lastname }}</td>
                                        <td class="p-4 text-left">
                                            ...
                                            @if ($project->techSupervisor)
                                                <div
                                                    ...
                                                    <img src="{{ asset('storage/' . $project->techSupervisor->profile_pic) }}"
                                        ...
                                        <td id="itemstatus" class="p-4 font-normal text-[15px]">
                                            {{ $project->start_date->diffForHumans() }}</td>
