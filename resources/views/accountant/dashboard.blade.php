    ...
    <main class="ml-64 flex-1 bg-[#F9F7F7] min-h-screen  items-center">
                        ...
                        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 ">
                            ...
                            <div class="flex mt-2 ml-1 justify-left items-left">
                                <h2 class=" font-semibold text-[30px]  text-gray-900">
                                    ...
                                    @if ($debt < 0)
                                        <p class="font-bold text-[35px]  text-gray-900">GH₵
        ...
        8.2%
                                ...
                                @if ($percentageChangeI > 0)
                                    <span class="flex items-center w-full h-full mt-[20px] ">
                                        <p class="flex text-gray-500"> {!! $arrowUpI !!}<span
                                                class="text-green-600">
                                    ...
                                    <div class="flex items-center mt-1 space-x-4">
                                        {{-- <h1 class="text-3xl font-bold text-gray-900">$201,221.05</h1> --}}
                                        <span
                                            class="flex items-center px-3 py-1 text-sm font-semibold text-green-600 bg-green-100 rounded-full">
                                            {!! $arrowUpI !!}
                                ...
                                @elseif ($percentageChangeI < 0)
                                    <div class="flex items-center mt-1 space-x-4">
                                        {{-- <h1 class="text-3xl font-bold text-gray-900">$201,221.05</h1> --}}
                                        <span
                                            class="flex items-center px-3 py-1 text-sm font-semibold text-red-600 bg-red-100 rounded-full">
                                            {!! $arrowDownI !!}
