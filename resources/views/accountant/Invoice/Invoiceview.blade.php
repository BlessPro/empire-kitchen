                    ...
                    <div class="max-w-3xl mx-auto bg-white  rounded-md shadow-md text-sm text-gray-800 font-sans">
                        ...
                        <div class="p-10">
                            <div class="flex justify-between items-start mb-6">
                                ...
                                <!-- Left: Logo -->
                                <div class="w-1/2">
                                    <img src="{{ asset('storage/images-one/empire logo-new.png') }}" alt="Empire Logo"
                                        class="h-16">
                                </div>
                        ...
                        <div
                            class="bg-[#6B1E7233] p-6 text-gray-800 text-sm grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div class="text-left">
                                ...
                                <p class="mt-4">
                                    ...
                                    <a href="mailto:info@empirekitchen.com"
                                        class="text-purple-800 underline">info@empirekitchen.com</a>
                                </p>
                            </div>
                            ...
                            <div class="flex justify-end items-start">
                                <div class="text-right">
                                    ...
                                    {{-- QR Code --}}
                                    <img src="{{ asset('storage/images-one/blank_qr_code.png') }}" alt="QR Code"
                                        class="w-32 mt-2">
                                </div>
                            </div>
                        </div>
