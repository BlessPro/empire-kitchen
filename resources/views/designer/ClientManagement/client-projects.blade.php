                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <span><i data-feather="chevron-right"
                                ...
                                class="font-semibold text-fuchsia-900">{{ $client->title . ' ' . $client->firstname . ' ' . $client->lastname }}</span>
                        </div>
                                            ...
                                            <div class="flex items-center justify-between mt-4">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <span class="text-sm text-gray-700">
                                                        <p class="text-sm">
                                                            {{ $project->techSupervisor?->name ?? 'Not Assigned' }}</p>
                                                    </span>
                                                </div>
                        ...
                        <div>
                            <div class=" pt-3.5 pr-3 pb-4 pl-3 bg-[#F8FAFC] rounded-[40px] ">
                                <div class="flex items-center pl-2 pr-5 py-2 text-white rounded-full bg-[#4F46E5]">
                                    <span
                                        class="mr-2 font-semibold bg-white rounded-full px-[10px] py-[0px] items-center">
                                        <h5 class="items-center rounded-full px-[10px] py-[10px] text-black">
                                            {{ $ongoing->count() }}</h5>
                                    </span> Ongoing
                                </div>
                                            ...
                                            <div class="p-5 bg-white rounded-[20px] mb-[20px] shadow hover:bg-gray-100">
                                                ...
                                                <div class="flex items-center justify-between mt-4">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <span class="text-sm text-gray-700">
                                                            <p class="text-sm">
                                                                {{ $project->techSupervisor?->name ?? 'Not Assigned' }}
                                                            </p>
                                                        </span>
                                                    </div>
                                                    <div class="flex items-center gap-1 text-sm text-gray-400">
                                    ...
                                    @foreach ($completed as $project)
                                        <a href="{{ route('admin.projects.info', $project->id) }}">
                                            <div class="p-5 bg-white rounded-[20px] mb-[20px] shadow hover:bg-gray-100">
                                                ...
                                                <div class="flex items-center justify-between mt-4">
                                                    <div class="flex items-center gap-3">
                                                        <img alt="technical supervisor" class="w-8 h-8 rounded-full">
                                                        <span class="text-sm text-gray-700">
                                                            <p class="text-sm">
                                                                {{ $project->techSupervisor?->name ?? 'Not Assigned' }}
                                                            </p>
