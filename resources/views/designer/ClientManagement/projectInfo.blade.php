                   ...
                   <div class="flex items-center justify-between mb-6">
                       <div class="flex items-center justify-between mb-6">
                           ...
                           <a href="{{ route('designer.AssignedProjects') }}">
                               <h3 class="font-sans font-normal text-black cursor-pointer hover:underline">Assigned
                                   Projects</h3>
                           </a>
                       ...
                       <div class="p-6 bg-white shadow lg:col-span-2 rounded-xl">
                           ...
                           <div class="flex items-center justify-between mb-6">
                               <div class="flex items-center justify-between mb-6">
                                   ...
                                   <span
                                       class="inline-block mt-1 px-3 py-0.5 text-xs bg-green-100 text-green-600 rounded-full ml-[6px] {{ $statusClasses[$project->status] ?? $defaultClass }}">{{ $project->status }}</span>
                               ...
                               <div class="flex text-sm text-right text-gray-600">
                                   <span><i data-feather="home" class="text-fuchsia-900 mr-[12px] ml-[3px]"></i></span>
                                   </span><span
                                       class="mr-[12px] font-semibold text-fuchsia-900">{{ $project->client->title . ' ' . $project->client->firstname . ' ' . $project->client->lastname }}</span>
                                   </span>
                               </div>
                           ...
                           <div class="mt-6">
                               ...
                               <div class="flex gap-4">
                                   @foreach ($project->measurement as $measurement)
                                       ...
                                       <div class="flex items-center gap-1">
                                           📐 <span>
                                               <p>Width: {{ $measurement->width }}</p>
                                           </span>
                                       </div>
                                       <div class="flex items-center gap-1">
                                           📐 <span>
                                               <p>Length: {{ $measurement->height }}</p>
                                           </span>
                                       </div>
                                   @endforeach
                       ...
                       <div class="flex flex-col justify-between p-6 bg-white shadow rounded-xl">
                           ...
                           <div class="mt-6">
                               ...
                               <form method="POST" id="commentForm"
                                   ...
                                   <button type="submit" class="px-4 py-2 mt-2 text-white rounded bg-fuchsia-900">Post
                                       Comment</button>
                               </form>
                           </div>
                       </div>
                   ...
                   <div id="addClientModal"
                       ...
                       <div class="bg-white rounded-lg p-6 w-[600px] items-center justify-center relative">
                           <div class="flex flex-col justify-between gap-4 mb-4 sm:flex-row">
                               ...
                               <button type="button" id="cancelAddClient" class="px-4 py-2 text-black "> <i
                           ...
                           <form id="addClientForm" method="POST">
                               ...
                               <div class="flex flex-col gap-4 sm:flex-row">
                                   ...
                                   <div class="mb-4">
                                       <label for="lastName" class="block mb-3 text-sm font-medium text-gray-700">Last
                                           Name</label>
                                       <input id="lastName" name="lastname" id="lastName"
                               ...
                               <div class="flex flex-col gap-4 sm:flex-row">
                                   ...
                                   <div class="mb-4">
                                       <label for="otherNames"
                                           class="block mb-3 text-sm font-medium text-gray-700">Other Names</label>
                                   ...
                                   <div class="mb-4">
                                       <label for="title"
                                           class="block mb-3 text-sm font-medium text-gray-700">Title</label>
                               ...
                               <button type="submit"
                                   class="bg-fuchsia-900 w-full text-[20px] text-white px-4 py-2 rounded">Save
                                   Client</button>
                       </div>
                       ...
                       <div class="w-full max-w-sm p-6 bg-white rounded-lg">
                           ...
                           <div class="flex justify-end">
                               <button id="closeSuccessModal"
                                   class="px-4 py-2 text-white rounded-full bg-fuchsia-900">
                                   OK
                               </button>
                           </div>
                       </div>
