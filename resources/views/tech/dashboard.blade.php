        ...
        <div class=" max-w-7xl px-4 py-4 sm:px-6 lg:px-8 xl:px-10 mx-auto">
            <div class="grid grid-cols-1 gap-6 xl:grid-cols-3 xl:gap-8">
                ...
                <div class="space-y-6 xl:col-span-2">
                    <h1 class="text-2xl font-bold text-slate-900">Project Phases</h1>
                    ...
                    <section id="overview" class="bg-white border border-gray-200 shadow-sm rounded-2xl">
                        ...
                        <!-- Segmented bar -->
                        <div class="px-6 mt-4">
                            <div class="w-full h-3 overflow-hidden bg-gray-100 rounded-full" role="img"
                        ...
                        <!-- Legend -->
                        <div id="ov-legend" class="grid grid-cols-2 gap-4 px-6 py-5 sm:grid-cols-4">
                            <!-- items injected --></div>
                    </section>
                    ...
                    <div class="px-4 py-5 space-y-4 sm:px-6">
                        ...
                        @empty
                            <div
                                class="p-6 text-sm text-center text-gray-500 border border-gray-300 border-dashed rounded-xl">
                ...
                <div class="space-y-6">
                    <!-- RECENT ACTIVITIES -->
                    <section class=" mt-[55px] bg-white border border-gray-200 shadow-sm rounded-2xl">
                        <div class="px-6 pt-6">
                                        ...
                                        <div class="flex items-start gap-3 py-3">
                                            @if (!empty($activity['user_avatar']))
                                                <img src="{{ $activity['user_avatar'] }}"
                                                    ...
                                                    class="object-cover w-10 h-10 rounded-full shadow ring-2 ring-white">
                                            @else
                                                <div
                                                    class="flex items-center justify-center w-10 h-10 text-sm font-semibold uppercase rounded-full bg-slate-200 text-slate-600 shadow ring-2 ring-white">
                                            ...
                                            <div class="min-w-0">
                                                <p class="text-sm leading-6 text-gray-700">
                                                    <span
                                                        class="font-medium text-gray-900">{{ $activity['user_name'] }}</span>
                                                    <span class="text-gray-600"> {{ $activity['description'] }} </span>
                                                    <span
                                                        class="font-medium text-purple-700">{{ $activity['project_name'] }}</span>
                                                </p>
                                                @if (!empty($activity['time']))
                                                    <p
                                                        class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400">
                                                        {{ $activity['time'] }}</p>
                                                @endif
                                            </div>
                                        </div>
