        ...
        <div class="mb-20 bg-white shadow rounded-2xl">
            ...
            <div class="overflow-x-auto">
                ...
                <tr class="cursor-pointer hover:bg-gray-100">
                    <td class="p-4 font-normal text-[15px] items-center">Pink Kitchen</td>

                    <td class="p-4 font-normal text-[15px] items-center">Ashaiman</td>
                    <td class="p-4 font-normal text-[15px] items-center">January 11, 2025</td>
                    <td class="p-4 font-normal text-[15px] items-center">3.4/6.66ft</td>

                    <td class="p-4 font-normal text-[15px] items-center">4.3/6.66ft</td>
                    <td class="p-4 font-normal text-[15px] items-center">5.4/6.66ft</td>
